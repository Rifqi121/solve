...
<head>
    ...
    <link rel="stylesheet" href="css/tanda-tangan-petisi.css">
</head>
<body id="body">
    <div class="blur">
        <div class="modal">
    ...
    <main>
        <section id="card-container">
            <div class="content-card">
                ...
                <div id="form-content">
                    <div class="input">
                        <label for="judul"><span>*</span> Nama Lengkap</label>
                        <input type="text" name="judul" id="inp-judul" placeholder="Masukkan nama Anda" style="margin-top: 12px;">
                    </div>
                    <div class="input">
                        <label for="judul"><span>*</span> Alasan</label>
                        <p>Silakan jelaskan dengan jelas alasan Anda mengapa mendukung petisi ini
                            sebagai bahan pertimbangan
                        </p>
                        <textarea name="deskripsi" id="inp-deskipsi" cols="30" rows="10" placeholder="Sampaikan alasanmu di sini ..."></textarea>
                    </div>
                    <div class="input">
                        <label for=""><span>*</span> Tambahkan Gambar</label>
                        <p>Lampirkan bukti tanda tangan</p>
                        <div class="input-file">
                            <input type="file" name="lampiran" id="lampiran">
                            <label for="lampiran"><i class="fa-solid fa-upload" style="color: #ffffff;"></i>Upload Tanda Tangan</label>
                        </div>
                    </div>
                    <div class="input">
                        <div class="checkbox">
                            <input type="checkbox" name="nama" id="nama-checkbox">
                            <p>Tampilkan tanda tangan dan alasan saya secara umum</p>
                        </div>
                    </div>
                </div>
                <div id="ttd">
                        <button id="ttd-btn">Tanda Tangani</button>
                </div>
